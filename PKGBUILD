...
pkgver=2018.08.03.r4665.gc8c308362.4.17.10.1
pkgrel=1
makedepends=("linux-vfio-headers=4.17.10-1" "git")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.08.03.r4665.gc8c308362" "linux-vfio=4.17.10-1")
