...
pkgver=2018.06.25.r4612.ga8577bdb3.4.17.2.1
pkgrel=1
makedepends=("linux-vfio-headers=4.17.2-1" "git")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=a8577bdb32e091645df901d8501e44ef50748389")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.06.25.r4612.ga8577bdb3" "linux-vfio=4.17.2-1")
...
package_zfs-linux-vfio-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.17.2-1-vfio/Module.symvers
}
