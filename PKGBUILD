...
pkgver=2018.08.23.r4692.g55972a672.4.17.14.arch1.1
pkgrel=1
makedepends=("linux-vfio-headers=4.17.14.arch1-1" "git")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.08.23.r4692.g55972a672" "linux-vfio=4.17.14.arch1-1")
