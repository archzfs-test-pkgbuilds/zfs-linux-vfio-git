...
pkgver=2018.08.17.r4677.g802715b74.4.17.14.
pkgrel=1
makedepends=("linux-vfio-headers=4.17.14." "git")
arch=("x86_64")
...
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.08.17.r4677.g802715b74" "linux-vfio=4.17.14.")
