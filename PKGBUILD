...
pkgver=2018.06.21.r4611.g7637ef8d2.4.17.2.1
pkgrel=1
makedepends=("linux-vfio-headers=4.17.2-1" "git")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=7637ef8d235f34876c8600e3006e0bb9763b24d8")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.06.21.r4611.g7637ef8d2" "linux-vfio=4.17.2-1")
