...
pkgver=2018.05.21.r3488.ga430cef9c.4.16.8.1
pkgrel=1
makedepends=("linux-vfio-headers=4.16.8-1" "git" "spl-linux-vfio-git-headers")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "spl-linux-vfio-git" "zfs-utils-common-git>=2018.05.21.r3488.ga430cef9c" "linux-vfio=4.16.8-1")
...
package_zfs-linux-vfio-git-headers() {
    ...
    sed -i "s+${srcdir}++" ${pkgdir}/usr/src/zfs-*/4.16.8-1-vfio/Module.symvers
}
