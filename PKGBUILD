...
pkgver=2018.07.09.r4628.ga7ed98d8b.4.17.3.1
pkgrel=1
makedepends=("linux-vfio-headers=4.17.3-1" "git")
arch=("x86_64")
url="http://zfsonlinux.org/"
source=("git+https://github.com/zfsonlinux/zfs.git#commit=a7ed98d8b5cefbd62ed39b9cf25860dad3922861")
sha256sums=("SKIP")
license=("CDDL")
depends=("kmod" "zfs-utils-common-git=2018.07.09.r4628.ga7ed98d8b" "linux-vfio=4.17.3-1")
